...
###################################################################################################
                    ...
                    return redirect('/MackCycleGan-VC')
        #!Nothing
        #flash(Markup(f"<strong>You are't upload!</strong> Please upload file."))
        flash(Markup(f"<div class='alert alert-warning alert-dismissible fade show' role='alert' style='margin-top: 5px;'><strong>You are't upload!</strong> Please upload file. <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>"))
        return redirect('/MackCycleGan-VC')
